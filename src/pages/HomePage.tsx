...
const HomePage: React.FC = () => {
  ...
  const handleUploadSuccess = async (wordlist: Wordlist) => {
    ...
    try {
      ...
      // Close the modal only after data is refreshed
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-secondary-50 to-white flex flex-col transition-colors dark:bg-gradient-to-b dark:from-secondary-900 dark:to-secondary-950">
      <Header showBack={false} />

      {isLoading ? (
        <div className="flex-1 flex items-center justify-center">
          <Preloader fullscreen={false} message="Loading languages..." />
        </div>
      ) : (
        <main className="container-content py-3 sm:py-4">
          ...
          {filteredWordlists.length > 0 ? (
            ...
            <div className="card p-4 sm:p-5 text-center mt-3 sm:mt-4 border-dashed border-2 bg-secondary-50/50 dark:bg-secondary-800/50 dark:border-secondary-700">
